...
def main(bundle_dir=None):
    ...
    if sys.platform == "win32":
        ...
        render_openssl_symlinks('%s/deps/luvit/deps/openssl/openssl/include/openssl' % bundle_dir,
            '%s/deps/luvit/deps/openssl/openssl-configs/realized/openssl' % bundle_dir)
